...
/// @brief Maps alphabet index (0-25) to Morse code strings for the receiver.
...
/// @brief Hardware timer pulse sequences for each letter.
/* NOTE: These arrays are declared static to keep them private to this file. 
 * Other files only access them through the lookup table. */
...
/// @brief Links ASCII characters to their specific timing patterns and array lengths.
...
/// @brief The total number of items inside the Morse lookup table.
